...
Two states of one character, drawn by Naveed.
    ...
    E001  resting   three dots — the code and the reasoning still mixed,
                    and none of it read yet
    E002  reading   the same face with its eyes open
...
To change the drawing: edit the proportions at the top of the script, run it,
and copy the new `.woff` here. Nothing else needs touching — the two names in
